...
const PLAIN_KEYS = [
    ...
    "Competition.Match.Help",
    "Competition.Match.NotAMatch",
    "Competition.Match.Home",
    "Competition.Match.Away",
    "Competition.Match.SiteHelp",
    "Competition.Match.Current",
    "Competition.Match.Games",
    "Competition.Match.Mixed",
    "Competition.Match.Apply",
